const fr = {
  ...
  contributeDescription:
    'Importez une capture d’écran en 2560×1440 pour détecter automatiquement les runs. Vérifiez et corrigez les valeurs avant de les enregistrer dans la base de données.',
  contributeUploadLabel: 'Capture d’écran',
  contributeUploadHint: 'Sélectionnez une image PNG ou JPEG au format 2560×1440.',
  contributeImagesTitle: 'Image sélectionnée',
  ...
  contributeTooMany: 'Vous ne pouvez importer qu’une seule image à la fois.',
