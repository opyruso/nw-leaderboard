const en = {
  ...
  contributeDescription:
    'Upload up to six screenshots captured at 2560×1440 to detect runs automatically. Review and edit the extracted data before saving it to the leaderboard.',
  contributeUploadLabel: 'Screenshots',
  contributeUploadHint: 'Select up to six PNG or JPEG images with a 2560×1440 resolution.',
  contributeImagesTitle: 'Selected images',
  contributeFilesReady: 'Images ready for extraction.',
  contributeFileLoadError: 'Unable to analyse one of the selected images. Please try again.',
  contributeTooMany: 'You can upload up to six images at a time.',
  contributeResolutionError: 'Only screenshots rendered at 2560×1440 are accepted.',
  contributeNoFiles: 'Select at least one screenshot before extracting.',
  ...
  contributeNoResults: 'No run detected on these screenshots.',
  ...
  contributePlayersHint: 'Adjust the player list if the OCR missed someone.',
  contributePlayerPlaceholder: 'Player name',
  contributeAddPlayer: 'Add a player',
  contributeRemovePlayer: 'Remove',
