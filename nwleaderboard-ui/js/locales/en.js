const en = {
  ...
  contributeDescription:
    'Upload a 2560×1440 screenshot to detect runs automatically. Review and edit the extracted data before saving it to the leaderboard.',
  contributeUploadLabel: 'Screenshot',
  contributeUploadHint: 'Select a PNG or JPEG image with a 2560×1440 resolution.',
  contributeImagesTitle: 'Selected image',
  ...
  contributeTooMany: 'You can upload only one image at a time.',
